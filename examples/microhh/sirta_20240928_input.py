...
settings = {
    ...
    'central_lon' : 2.204,
    'area_size'   : 1,
    'case_name'   : 'sirta20240928',
    'era5_path'   : '/home/MINES/maragoncerecedes/projects/WUR/LS2D/examples/microhh/',
    'start_date'  : datetime(year=2024, month=9, day=28, hour=6),
    'end_date'    : datetime(year=2024, month=9, day=28, hour=18),
    'write_log'   : True,
    'data_source' : 'CDS'
    }
...
# Update namelist
#
nl = mlt.read_namelist('sirta20240928.ini.base')
...
mlt.write_namelist('sirta20240928.ini', nl)
