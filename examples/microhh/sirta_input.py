...
settings = {
    ...
    'start_date'  : datetime(year=2024, month=6, day=25, hour=4),
    'end_date'    : datetime(year=2024, month=6, day=25, hour=18),
    'write_log'   : True,
    'data_source' : 'CDS'
    }
...
# Update namelist
#
nl = mlt.read_namelist('sirta.ini.base')
...
mlt.write_namelist('sirta.ini', nl)
