...
settings = {
    ...
    'start_date'  : datetime(year=2024, month=7, day=28, hour=4),
    'end_date'    : datetime(year=2024, month=7, day=28, hour=18),
    'write_log'   : True,
    'data_source' : 'CDS'
    }
...
# Update namelist
#
nl = mlt.read_namelist('juelich.ini.base')
...
mlt.write_namelist('juelich.ini', nl)
