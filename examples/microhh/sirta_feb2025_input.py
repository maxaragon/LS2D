...
# LS2D & custom modules
sys.path.insert(0, os.path.abspath('/home/MINES/maragoncerecedes/projects/WUR/LS2D'))
...
settings = {
    ...
    'central_lon' : 2.204,
    'area_size'   : 1,
    'case_name'   : 'sirta20250213',
    'era5_path'   : '/home/MINES/maragoncerecedes/projects/WUR/LS2D/examples/microhh/',
    'start_date'  : datetime(year=2025, month=2, day=13, hour=6),
    'end_date'    : datetime(year=2025, month=2, day=13, hour=18),
    'write_log'   : True,
    'data_source' : 'CDS'
    }
...
# Define vertical grid LES (equidistant):
grid = ls2d.grid.Grid_equidist(kmax=250, dz0=20)
...
mlt.write_netcdf_input(
        'sirta', 'f8', init_profiles,
        timedep_surface, timedep_ls, radiation, soil)

#
# Update namelist
#
nl = mlt.read_namelist('sirta20250213.ini.base')
...
mlt.write_namelist('sirta20250213.ini', nl)
