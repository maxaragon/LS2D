...
settings = {
    ...
    'central_lon' : 2.204,
    'area_size'   : 1,
    'case_name'   : 'sirta20240624',
    'era5_path'   : '/home/MINES/maragoncerecedes/projects/WUR/LS2D/examples/microhh/',
    'start_date'  : datetime(year=2024, month=6, day=24, hour=6),
    'end_date'    : datetime(year=2024, month=6, day=24, hour=18),
    'write_log'   : True,
    'data_source' : 'CDS'
    }
...
# Update namelist
#
nl = mlt.read_namelist('sirta20240624.ini.base')
...
mlt.write_namelist('sirta20240624.ini', nl)
